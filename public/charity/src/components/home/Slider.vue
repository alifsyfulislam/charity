<template>
    <div>
        <div class="owl-slider hero-content-wrap">
            <carousel
                    :items="1"
                    :interval="7000"
                    :dots="false"
                    ...
                    :autoplay="true"
                    :navText="[
                                    `<i class='fas fa-chevron-left slider-icon' aria-hidden='true'></i>`,
...
<style>
    ...
    i.fas.fa-chevron-right.slider-icon {
    ...
    i.fas.fa-chevron-left.slider-icon {
        width: 60px;
        height: 60px;
        border-radius: 50%;
