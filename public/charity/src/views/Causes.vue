                ...
                <div class="row">
                    <div class="col-12 col-lg-6">
                        <div class="cause-wrap d-flex flex-wrap justify-content-between">
                            <figure class="m-0">
                                <img src="../assets/images/xfeatured-causes.jpg.pagespeed.ic.yeVYLszSKo.jpg" alt="">
                            </figure>
                            <div class="cause-content-wrap">
                                ...
                                <div class="entry-content">
                                    <p class="m-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris tempus vestib ulum
                            ...
                            <div class="fund-raised w-100">
                                <div class="fund-raised-bar-1 barfiller">
                                    <div class="tipWrap" style="display: inline;">
                                        <span class="tip" style="left: 195.38px; transition: left 1.5s ease-in-out 0s;">83%</span>
                                    </div>
                                    <span class="fill" data-percentage="83" style="background: rgb(255, 90, 0); width: 237.38px; transition: width 1.5s ease-in-out 0s;"></span>
                                </div>
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="cause-wrap d-flex flex-wrap justify-content-between">
                            <figure class="m-0">
                                <img src="../assets/images/xeye-for.jpg.pagespeed.ic.fZxC6aItuf.jpg" alt="">
                            </figure>
                            <div class="cause-content-wrap">
                                <header class="entry-header d-flex flex-wrap align-items-center">
                                    <h3 class="entry-title w-100 m-0"><a href="#">Fundraiser for Kids</a></h3>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                        <div class="swiper-slide" >
                            <div class="cause-wrap">
                                <figure class="m-0">
                                    <img src="../assets/images/xcause-1.jpg.pagespeed.ic.RNPfjTVF3d.jpg" alt="">
